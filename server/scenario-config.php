...
return [
    ...
    'narration' => [
        'home' => [
            ...
            'text' => "Welcome! I will help you practise recognising scam calls safely. Family Voice Training. A familiar voice can make an impersonation scam much harder to recognise.",
        ],
        ...
        [
            ...
            'nodes' => [
                ...
                'user01' => [
                    ...
                    'text' => "That sounds serious. Where are you exactly? I will call the hotel and check what's happened first.",
                    'rating' => 'SAFE',
                ...
                'user02' => [
                    ...
                    'text' => "Oh no, I'm sorry you're stuck. Of course I will help you. How much money do you need?",
                    'rating' => 'UNSAFE',
                ...
                'user03' => [
                    ...
                    'text' => "I'm worried about you. I'm going to call you back on your usual number first.",
                    'rating' => 'SAFE',
                ...
                'user04' => [
                    ...
                    'text' => "I understand, but I'm still going to call the hotel myself before I do anything.",
                    'rating' => 'SAFE',
                ...
                'user05' => [
                    ...
                    'text' => "Okay, I won't call them. Just tell me what I need to do.",
                    'rating' => 'UNSAFE',
                ...
                'user06' => [
                    ...
                    'text' => "If you're really my daughter, you should be okay with me checking this first.",
                    'rating' => 'SAFE',
                ...
                'user07' => [
                    ...
                    'text' => "I understand, but I want to make sure it's really you before I send any money.",
                    'rating' => 'SAFE',
                ...
                'user08' => [
                    ...
                    'text' => "Okay, I understand. Just give me the account details.",
                    'rating' => 'UNSAFE',
                ...
                'user09' => [
                    ...
                    'text' => "Why can't you access your normal bank account? I want to understand what happened first.",
                    'rating' => 'UNSURE',
                ...
                'user10' => [
                    ...
                    'text' => "If your phone isn't working, I'll contact you another way that I already know is yours.",
                    'rating' => 'SAFE',
                ...
                'user11' => [
                    ...
                    'text' => "Okay, I'll stay on the phone. Tell me what you need me to do.",
                    'rating' => 'UNSAFE',
                ...
                'user12' => [
                    ...
                    'text' => "This sounds unusual. I'm going to stop here and contact you through another method.",
                    'rating' => 'SAFE',
                ...
                'user13' => [
                    ...
                    'text' => "I'm not sending money until I can confirm who I'm speaking to.",
                    'rating' => 'SAFE',
                ...
                'user14' => [
                    ...
                    'text' => "Okay, I won't call the hotel. What account should I send the money to?",
                    'rating' => 'UNSAFE',
                ...
                'user15' => [
                    ...
                    'text' => "I'm going to hang up and contact you another way.",
                    'rating' => 'SAFE',
                ...
                'user16' => [
                    ...
                    'text' => "I'm not transferring anything until I verify this with you another way.",
                    'rating' => 'SAFE',
                ...
                'user17' => [
                    ...
                    'text' => "Okay, send me the account details and I'll transfer it.",
                    'rating' => 'UNSAFE',
                ...
                'user18' => [
                    ...
                    'text' => "Why do you need a new account? I'm going to check what's happening first.",
                    'rating' => 'UNSURE',
                ...
                'user19' => [
                    ...
                    'text' => "I care about you, but I'm still going to verify this before sending money.",
                    'rating' => 'SAFE',
                ...
                'user20' => [
                    ...
                    'text' => "Okay, I trust you. Tell me where to send the money.",
                    'rating' => 'UNSAFE',
                ...
                'user21' => [
                    ...
                    'text' => "I'm going to call you back on the number I already have for you.",
                    'rating' => 'SAFE',
                ...
                'user22' => [
                    ...
                    'text' => "I want to help, but I'm going to verify your identity first.",
                    'rating' => 'SAFE',
                ...
                'user23' => [
                    ...
                    'text' => "Okay, I believe you. Send me the account details.",
                    'rating' => 'UNSAFE',
                ...
                'user24' => [
                    ...
                    'text' => "What was the name of our first family pet?",
                    'rating' => 'SAFE',
                ...
                'user25' => [
                    ...
                    'text' => "Before I send anything, I'm going to contact you using a number I already have.",
                    'rating' => 'SAFE',
                ...
                'user26' => [
                    ...
                    'text' => "Okay, send me the account details.",
                    'rating' => 'UNSAFE',
                ...
                'user27' => [
                    ...
                    'text' => "I'm not comfortable sending money without checking this first.",
                    'rating' => 'UNSURE',
                ...
                'user28' => [
                    ...
                    'text' => "I'll contact the bank or check with you another way before doing anything.",
                    'rating' => 'SAFE',
                ...
                'user29' => [
                    ...
                    'text' => "Okay, just send me the new account details.",
                    'rating' => 'UNSAFE',
                ...
                'user30' => [
                    ...
                    'text' => "That doesn't sound right. I'm going to verify this before I send anything.",
                    'rating' => 'SAFE',
                ...
                'user31' => [
                    ...
                    'text' => "If this is really you, you won't mind me taking a moment to verify it.",
                    'rating' => 'SAFE',
                ...
                'user32' => [
                    ...
                    'text' => "Okay, tell me the account details.",
                    'rating' => 'UNSAFE',
                ...
                'user33' => [
                    ...
                    'text' => "I'm going to stop the call and contact you another way.",
                    'rating' => 'SAFE',
                ...
                'user34' => [
                    ...
                    'text' => "I'm not transferring anything until I verify who you are.",
                    'rating' => 'SAFE',
                ...
                'user35' => [
                    ...
                    'text' => "Okay, how do I transfer it?",
                    'rating' => 'UNSAFE',
                ...
                'user36' => [
                    ...
                    'text' => "I'm going to contact you another way first.",
                    'rating' => 'SAFE',
                ...
                'user37' => [
                    ...
                    'text' => "I understand, but I'm going to verify this before doing anything.",
                    'rating' => 'SAFE',
                ...
                'user38' => [
                    ...
                    'text' => "Okay, I'll stay on the call. Tell me what you need.",
                    'rating' => 'UNSURE',
                ...
                'user39' => [
                    ...
                    'text' => "I'm going to contact you through a number or method I already know.",
                    'rating' => 'SAFE',
                ...
                'user40' => [
                    ...
                    'text' => "I still need to verify that this is really you before I do anything.",
                    'rating' => 'SAFE',
                ...
                'user41' => [
                    ...
                    'text' => "I want to help, but tell me exactly what happened first.",
                    'rating' => 'UNSURE',
                ...
                'user42' => [
                    ...
                    'text' => "Okay, just give me the account details.",
                    'rating' => 'UNSAFE',
                ...
                'user43' => [
                    ...
                    'text' => "I'm going to verify this before sending anything.",
                    'rating' => 'SAFE',
                ...
                'user44' => [
                    ...
                    'text' => "Why does the money have to be sent right now?",
                    'rating' => 'UNSURE',
                ...
                'user45' => [
                    ...
                    'text' => "Okay, I'll transfer the money.",
                    'rating' => 'UNSAFE',
                ...
                'user46' => [
                    ...
                    'text' => "Actually, I want to check that this is really you first.",
                    'rating' => 'SAFE',
                ...
                'user47' => [
                    ...
                    'text' => "Wait, why is the account different?",
                    'rating' => 'UNSURE',
                ...
                'user48' => [
                    ...
                    'text' => "Okay, tell me where to send the $800.",
                    'rating' => 'UNSAFE',
                ...
                'user49' => [
                    ...
                    'text' => "Tell me the name of our first family pet.",
                    'rating' => 'SAFE',
                ...
                'user50' => [
                    ...
                    'text' => "Why don't you want me to contact anyone else?",
                    'rating' => 'UNSURE',
                ...
                'user51' => [
                    ...
                    'text' => "Fine, I'll trust you. What do I need to do?",
                    'rating' => 'UNSAFE',
                ...
                'user52' => [
                    ...
                    'text' => "Before we continue, answer a question only my daughter would know.",
                    'rating' => 'SAFE',
                ...
                'user53' => [
                    ...
                    'text' => "I'm still not sure about this. Explain what happened again.",
                    'rating' => 'UNSURE',
                ...
                'user54' => [
                    ...
                    'text' => "Okay, I'll stop asking questions. Tell me how to send it.",
                    'rating' => 'UNSAFE',
                ...
                'user55' => [
                    ...
                    'text' => "Hold on. I need to make sure this is really you.",
                    'rating' => 'SAFE',
                ...
                'user56' => [
                    ...
                    'text' => "I have the banking app open, but I'm still not sure about this.",
                    'rating' => 'UNSURE',
                ...
                'user57' => [
                    ...
                    'text' => "I'm ready. Give me the account details.",
                    'rating' => 'UNSAFE',
                ...
                'user58' => [
                    ...
                    'text' => "You didn't answer my question. I'm not sending anything.",
                    'rating' => 'SAFE',
                ...
                'user59' => [
                    ...
                    'text' => "Why are you avoiding my question?",
                    'rating' => 'UNSURE',
                ...
                'user60' => [
                    ...
                    'text' => "Maybe you're just stressed. Tell me the account details.",
                    'rating' => 'UNSAFE',
                ...
                'user61' => [
                    ...
                    'text' => "This isn't adding up. I'm going to verify the call.",
                    'rating' => 'SAFE',
                ...
                'user62' => [
                    ...
                    'text' => "I need you to explain why I can't contact anyone else.",
                    'rating' => 'UNSURE',
                ...
                'user64' => [
                    ...
                    'text' => "I'm stopping. I need to verify who I'm talking to.",
                    'rating' => 'SAFE',
                ...
                'user65' => [
                    ...
                    'text' => "Before I press send, why is this account different?",
                    'rating' => 'UNSURE',
                ...
                'user66' => [
                    ...
                    'text' => "Okay, I'm ready to make the transfer.",
                    'rating' => 'UNSAFE',
                ...
                'user67' => [
                    ...
                    'text' => "No. I'm going to hang up and call you on your usual number.",
                    'rating' => 'SAFE',
                ...
                'user68' => [
                    ...
                    'text' => "I'm not sending money yet, but I'll stay on the phone.",
                    'rating' => 'UNSURE',
                ...
                'user69' => [
                    ...
                    'text' => "Okay, I'll send it if you really need it.",
                    'rating' => 'UNSAFE',
                ...
                'user70' => [
                    ...
                    'text' => "I've heard enough. I'm going to verify this another way.",
                    'rating' => 'SAFE',
                ...
                'user71' => [
                    ...
                    'text' => "I'm still unsure. Give me a moment to think.",
                    'rating' => 'UNSURE',
                ...
                'user72' => [
                    ...
                    'text' => "Okay, I believe you. Let's make the transfer.",
                    'rating' => 'UNSAFE',
                ...
                'user73' => [
                    ...
                    'text' => "No. I've changed my mind. I'm going to verify this.",
                    'rating' => 'SAFE',
                ...
                'user74' => [
                    ...
                    'text' => "Wait. I'm not comfortable pressing send yet.",
                    'rating' => 'UNSURE',
                ...
                'user75' => [
                    ...
                    'text' => "I've entered the details. What do I do next?",
                    'rating' => 'UNSAFE',
                ...
                'user76' => [
                    ...
                    'text' => "I'm ending this call and contacting my daughter directly.",
                    'rating' => 'SAFE',
                ...
                'user77' => [
                    ...
                    'text' => "Give me one good reason why I shouldn't verify this first.",
                    'rating' => 'UNSURE',
                ...
                'user79' => [
                    ...
                    'text' => "No. I'm going to contact my daughter myself.",
                    'rating' => 'SAFE',
                ...
                'user80' => [
                    ...
                    'text' => "I still don't know if I believe you.",
                    'rating' => 'UNSURE',
                ...
                'user81' => [
                    ...
                    'text' => "Okay, I'll do what you're asking.",
                    'rating' => 'UNSAFE',
                ...
                'user82' => [
                    ...
                    'text' => "Stop. I'm not sending anything until I verify this.",
                    'rating' => 'SAFE',
                ...
                'user83' => [
                    ...
                    'text' => "I'm still worried something isn't right.",
                    'rating' => 'UNSURE',
                ...
                'user84' => [
                    ...
                    'text' => "Okay, I'm going to send the money now.",
                    'rating' => 'UNSAFE',
                ...
                'user85' => [
                    ...
                    'text' => "I'm hanging up and calling my daughter directly.",
                    'rating' => 'SAFE',
                ...
                'user86' => [
                    ...
                    'text' => "I'm going to contact another family member to check this.",
                    'rating' => 'SAFE',
                ...
                'user87' => [
                    ...
                    'text' => "I'll stay on the call and keep talking to you.",
                    'rating' => 'UNSURE',
                ...
                'user88' => [
                    ...
                    'text' => "I'm ending the call and verifying this independently.",
                    'rating' => 'SAFE',
                ...
                'user89' => [
                    ...
                    'text' => "I'm not sending money, but I'm still not sure what's happening.",
                    'rating' => 'UNSURE',
                ...
                'user90' => [
                    ...
                    'text' => "Okay, I trust you. I'll send the money.",
                    'rating' => 'UNSAFE',
                ...
                'user91' => [
                    ...
                    'text' => "No. I'm stopping the transfer and verifying who you are.",
                    'rating' => 'SAFE',
                ...
                'user92' => [
                    ...
                    'text' => "Wait. I need more time before I send anything.",
                    'rating' => 'UNSURE',
                ...
                'user93' => [
                    ...
                    'text' => "Okay, I'm sending the \$800 now.",
                    'rating' => 'UNSAFE',
